...
polygonDataTables_i=paste(getwd(),"/outputs/Maps/Tables/irrigation_water_demand_Reference.csv",sep="")
...
boundaryRegShpFolder_i=paste(ddir_metis,"/dataFiles/gis/naturalEarth",sep="")
