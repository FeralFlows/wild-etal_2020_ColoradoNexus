...
localBasinShapeFile = "ArgentinaLocalBasin_Corrected" # "colorado_10_subregions"
...
# subRegShpFile_i = paste('ArgentinaLocalBasin', sep = '') # localBasinShapeFile # paste("colorado_10_subregions",sep= "") #paste("colombiaLocalBasin",sep= "")
...
#                            minScale=c(0))
    ...
    if(param=='griddedScarcity'){
      ...
      numeric2Cat_list[['numeric2Cat_palette']] <- numeric2Cat_palette
        ...
        numeric2Cat_palette <- list(c("pal_green")) # Can be a custom scale or an R brewer paletter or a metis.pal
        numeric2Cat_list[['numeric2Cat_labels']] <- numeric2Cat_labels
        numeric2Cat_list[['numeric2Cat_breaks']] <- numeric2Cat_breaks
        numeric2Cat_list[['numeric2Cat_palette']] <- numeric2Cat_palette
