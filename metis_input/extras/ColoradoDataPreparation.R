# This file eliminates groundwater supply in the Colorado basin and instead forces all supply to be derived from
# surface water supply.

# User many need to modify file paths for use on their own workstation.
